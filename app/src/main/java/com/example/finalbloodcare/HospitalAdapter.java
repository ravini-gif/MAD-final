...
public class HospitalAdapter extends RecyclerView.Adapter<HospitalAdapter.MyViewHolder> {
    ...
    Activity activity;
    private ArrayList hos_id, hos_name, hos_mail, hos_no;


    HospitalAdapter(Activity activity, Context context, ArrayList hos_id, ArrayList hos_name, ArrayList hos_mail,
                    ArrayList hos_no) {
        this.activity = activity;
        this.context = context;
        this.hos_id = hos_id;
        this.hos_name = hos_name;
        this.hos_mail = hos_mail;
        this.hos_no = hos_no;
    }
    ...
    public MyViewHolder onCreateViewHolder(@androidx.annotation.NonNull ViewGroup parent, int viewType) {
        ...
        android.view.View view = inflater.inflate(R.layout.activity_my_row, parent, false);
    ...
    public void onBindViewHolder(@androidx.annotation.NonNull MyViewHolder holder, final int position) {
        ...
        holder.hos_mail_txt.setText(String.valueOf(hos_mail.get(position)));
        ...
        holder.mainLayout.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(android.view.View view) {
                Intent intent = new Intent(context, Edit_h_details.class);
                intent.putExtra("id", String.valueOf(hos_id.get(position)));
                intent.putExtra("name", String.valueOf(hos_name.get(position)));
                intent.putExtra("mail", String.valueOf(hos_mail.get(position)));
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        android.widget.TextView hos_id_txt, hos_name_txt, hos_mail_txt, hos_mob_txt;
        ...
        public MyViewHolder(@androidx.annotation.NonNull android.view.View itemView) {
            ...
            hos_mail_txt = itemView.findViewById(R.id.hos_mai_text);
